...
function updateButtons() {
  els.startBtn.disabled = state.running || state.rows.length === 0;
  els.stopBtn.disabled = !state.running;
  els.loadCrmBtn.disabled = state.running;
  els.crmPersonSelect.disabled = state.running || !state.crmData;
  if (els.crmDateRange) els.crmDateRange.disabled = state.running;
  if (els.requestSource) els.requestSource.disabled = state.running;
  els.accountCol.disabled = state.running;
  els.eventCol.disabled = state.running;
  els.startTime.disabled = state.running;
  els.endTime.disabled = state.running;
}
